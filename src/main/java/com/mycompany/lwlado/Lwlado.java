 ...
 */
package com.mycompany.lwlado;

/**
 *
 * @author SHIVALI
 */
public class Lwlado {public static void main(String[] args) {int llamas = 20; int whales =15; int dodos = 0;

if(dodos>0){System.out.println ( " Hold on, how can we have Negative dodos?");}
if(llamas > whales){
